(function ($) {
	...
	function rbtAjax() {
		...
		$.ajax({
			...
			// url: 'http://masterds.localhost/assets/plugins/rabbit-toolbar/templates/profile.php', /* LOCAL */
			type: "GET",
			data: {
				theme: rbtTheme,
			...
			success: function (data) {
				...
				showList();
				// rbtLoadScript('https://toolbar.qodeinteractive.com/assets/js/mc-validate.js');
			}
		});
	}
